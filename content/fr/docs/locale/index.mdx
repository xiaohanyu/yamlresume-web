...
<Cards>
  <Card
    ...
    href="/fr/docs/locale/brazilian-portuguese"
    description="Le portugais brésilien est une langue romance et la langue officielle du Brésil."
  />
  <Card
    title="Chinese"
  ...
  <Card
    title="Indonesian"
    href="/fr/docs/locale/indonesian"
    description="L'indonésien est la langue officielle de l'Indonésie, la plus grande nation archipelagique du monde."
  />
  <Card
    title="Japanese"
