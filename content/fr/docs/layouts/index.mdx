...
YAMLResume prend actuellement en charge quatre moteurs :

- [DOCX](./layouts/docx) : Génère des documents Microsoft Word.
- [HTML](./layouts/html) : Génère des versions HTML de votre CV.
...
<Cards>
  ...
  <Card
    href="./layouts/docx"
    title="Moteur DOCX"
    description="Générer des documents Microsoft Word"
  />
  <Card
    href="./layouts/html"
    title="Moteur HTML"
    description="Générer des versions HTML de votre CV"
  />
  <Card
    href="./layouts/latex"
    title="Moteur LaTeX"
