...
| Prop        | Type                                                                 | Requis | Description                            |
| ----------- | -------------------------------------------------------------------- | ------ | -------------------------------------- |
| `layouts[]` | [`DocxLayout`](#docxlayout) \| [`HtmlLayout`](#htmllayout) \| [`LatexLayout`](#latexlayout) \| [`MarkdownLayout`](#markdownlayout) | ⬜     | Configurations de mise en page multiples. |
...
| `lineSpacing?` | [`LineSpacing`](#linespacing)    | ⬜     | Interligne pour le document.            |
...
| `showIcons?` | `boolean`                            | ⬜     | Indique s'il faut afficher les icônes pour les liens et les profils. |
| `showUrls?`  | `boolean`                            | ⬜     | Indique s'il faut afficher les URL brutes ou les masquer derrière un texte raisonnable. |
...
Configuration de mise en page DOCX.

| Prop          | Type                                  | Requis | Description                                           |
| ------------- | ------------------------------------- | ------ | ----------------------------------------------------- |
| `engine`      | `'docx'`                              | ✅     | Le moteur pour générer le CV.                         |
| `advanced?`   | [`DocxAdvanced`](#docxadvanced)       | ⬜     | Définit les options de configuration avancées.        |
| `page?`       | [`DocxPage`](#docxpage)               | ⬜     | Définit les paramètres au niveau de la page.          |
| `sections?`   | [`Sections`](#sections)               | ⬜     | Définit les paramètres de personnalisation de section.|
| `template?`   | [`DocxTemplate`](#docxtemplate)       | ⬜     | Définit le modèle sélectionné.                        |
| `typography?` | [`DocxTypography`](#docxtypography)   | ⬜     | Définit les paramètres typographiques.                |

##### DocxAdvanced

Définit les options de configuration avancées pour DOCX.
...
| ------------------ | ---------------------- | ------ | ----------------------------------------------- |
| `margins?`         | [`Margins`](#margins)  | ⬜     | Définit les paramètres de marges de page.       |
| `paperSize?`       | [`DocxPaperSize`](#docxpapersize) | ⬜     | Définit la taille du papier.                    |
| `showPageNumbers?` | `boolean`              | ⬜     | Indique s'il faut afficher les numéros de page. |
...
| Prop          | Type                                | Requis | Description                              |
| ------------- | ----------------------------------- | ------ | --------------------------------------- |
| `fontSize?`   | [`DocxFontSize`](#docxfontsize)     | ⬜     | Taille de police de base pour le document. |
| `fontFamily?` | `string`                            | ⬜     | Une liste de familles de polices séparées par des virgules. |
| `lineSpacing?`| [`LineSpacing`](#linespacing)       | ⬜     | Interligne pour le document.            |
...
- `10.5pt` - taille de police 10.5pt
- `11pt` - taille de police 11pt
- `11.5pt` - taille de police 11.5pt
...
Un type union pour toutes les options de modèles DOCX possibles.
...
Ces valeurs sémantiques suivent l'échelle leading de Tailwind CSS :
