...
YAMLResume provides DOCX templates out of the box, you can list all templates
...
By default, YAMLResume uses [calm](./templates/calm) template for DOCX output.
...
<Cards>
  <Card
    href="/docs/layouts/docx/templates/calm"
    title="Calm"
    description="A clean and modern DOCX template"
  />
</Cards>
