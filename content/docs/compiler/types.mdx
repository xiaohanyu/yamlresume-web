...
| Prop        | Type                                                                 | Required | Description                            |
| ----------- | -------------------------------------------------------------------- | -------- | -------------------------------------- |
| `layouts[]` | [`DocxLayout`](#docxlayout) \| [`HtmlLayout`](#htmllayout) \| [`LatexLayout`](#latexlayout) \| [`MarkdownLayout`](#markdownlayout) | ⬜       | Multiple output layout configurations. |
...
| Prop       | Type                        | Required | Description                                                        |
| ---------- | --------------------------- | -------- | ------------------------------------------------------------------ |
| `aliases?` | `Record<SectionID, string>` | ⬜       | Custom aliases for section names, overriding default translations. |
...
| Prop          | Type                                  | Required | Description                                           |
| ------------- | ------------------------------------- | -------- | ----------------------------------------------------- |
| `engine`      | `'docx'`                              | ✅       | The engine to generate the resume.                    |
| `advanced?`   | [`DocxAdvanced`](#docxadvanced)       | ⬜       | Defines advanced configuration options.               |
| `page?`       | [`DocxPage`](#docxpage)               | ⬜       | Defines page-level settings for document presentation.|
| `sections?`   | [`Sections`](#sections)               | ⬜       | Defines section customization settings.               |
| `template?`   | [`DocxTemplate`](#docxtemplate)       | ⬜       | Defines the selected template.                        |
| `typography?` | [`DocxTypography`](#docxtypography)   | ⬜       | Defines typography settings for document formatting.  |
...
| ------------------ | ---------------------- | -------- | ------------------------------------ |
| `margins?`         | [`Margins`](#margins)  | ⬜       | Defines page margin settings.        |
| `paperSize?`       | [`DocxPaperSize`](#docxpapersize) | ⬜       | Defines the paper size.              |
| `showPageNumbers?` | `boolean`              | ⬜       | Whether to display page numbers.     |

##### DocxTypography

Defines DOCX typography settings for document formatting.

| Prop          | Type                                | Required | Description                      |
| ------------- | ----------------------------------- | -------- | -------------------------------- |
| `fontSize?`   | [`DocxFontSize`](#docxfontsize)     | ⬜       | Base font size for the document. |
| `fontFamily?` | `string`                            | ⬜       | A comma-separated list of font families to use. |
| `lineSpacing?`| [`LineSpacing`](#linespacing)       | ⬜       | Line spacing for the document.   |
...
- `10.5pt` - 10.5pt font size
- `11pt` - 11pt font size
- `11.5pt` - 11.5pt font size
- `12pt` - 12pt font size
