...
| Prop        | Tipo                                                                 | Requerido | Descripción                       |
| ----------- | -------------------------------------------------------------------- | --------- | --------------------------------- |
| `layouts[]` | [`DocxLayout`](#docxlayout) \| [`HtmlLayout`](#htmllayout) \| [`LatexLayout`](#latexlayout) \| [`MarkdownLayout`](#markdownlayout) | ⬜️       | Configuraciones de layout.        |
...
| `lineSpacing?`| [`LineSpacing`](#linespacing)     | ⬜️       | Espaciado de línea para el documento. |
...
| `showIcons?` | `boolean`                            | ⬜️       | Indica si se deben mostrar iconos para enlaces y perfiles. |
| `showUrls?`  | `boolean`                            | ⬜️       | Indica si se deben mostrar las URL en bruto u ocultarlas detrás de un texto razonable. |
...
Configuración de layout DOCX.

| Prop          | Tipo                                  | Requerido | Descripción                                           |
| ------------- | ------------------------------------- | --------- | ----------------------------------------------------- |
| `engine`      | `'docx'`                              | ✅        | Motor para generar el currículum.                     |
| `advanced?`   | [`DocxAdvanced`](#docxadvanced)       | ⬜️       | Opciones de configuración avanzada.                   |
| `page?`       | [`DocxPage`](#docxpage)               | ⬜️       | Configuración a nivel de página.                      |
| `sections?`   | [`Sections`](#sections)               | ⬜️       | Configuración de secciones.                           |
| `template?`   | [`DocxTemplate`](#docxtemplate)       | ⬜️       | Plantilla seleccionada.                               |
| `typography?` | [`DocxTypography`](#docxtypography)   | ⬜️       | Configuración tipográfica.                            |

##### DocxAdvanced

Opciones de configuración avanzada para DOCX.
...
Configuración a nivel de página para DOCX.

| Prop               | Tipo                   | Requerido | Descripción                |
| ------------------ | ---------------------- | --------- | -------------------------- |
| `margins?`         | [`Margins`](#margins)  | ⬜️       | Márgenes de página.        |
| `paperSize?`       | [`DocxPaperSize`](#docxpapersize) | ⬜️       | Define el tamaño de papel. |
| `showPageNumbers?` | `boolean`              | ⬜️       | Mostrar números de página. |

##### DocxTypography

Configuración tipográfica para DOCX.

| Prop          | Tipo                                | Requerido | Descripción                    |
| ------------- | ----------------------------------- | --------- | ------------------------------ |
| `fontSize?`   | [`DocxFontSize`](#docxfontsize)     | ⬜️       | Tamaño base de fuente.         |
| `fontFamily?` | `string`                            | ⬜️       | Una lista de familias de fuentes separada por comas. |
| `lineSpacing?`| [`LineSpacing`](#linespacing)       | ⬜️       | Espaciado de línea para el documento. |
...
- `10.5pt` - tamaño de fuente de 10.5pt
- `11pt` - tamaño de fuente de 11pt
- `11.5pt` - tamaño de fuente de 11.5pt
...
Estos valores semánticos siguen la escala leading de Tailwind CSS:
