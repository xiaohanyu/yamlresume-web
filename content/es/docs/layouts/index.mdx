...
A partir de v0.8.0, YAMLResume admite múltiples diseños y varios motores de salida (LaTeX, Markdown, HTML y DOCX) a través de la matriz `layouts`.
...
<Cards>
  ...
  <Card
    href="./layouts/docx"
    title="Motor DOCX"
    description="Genera currículums en Microsoft Word"
  />
  <Card
    href="./layouts/html"
    title="Motor HTML"
    description="Genera currículums HTML listos para la web"
  />
  <Card
    href="./layouts/latex"
    title="Motor LaTeX"
