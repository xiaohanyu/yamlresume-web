...
[https://yamlresume.dev/schema.json](https://yamlresume.dev/schema.json)。但是，如果您想要一個精簡版本用於您的 IDE/編輯器，您也可以使用我們 GitHub 倉庫中的 canary 版本 [schema.json](https://github.com/yamlresume/yamlresume/blob/main/packages/core/src/schema/schema.json)。
