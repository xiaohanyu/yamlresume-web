...
<Cards>
  <Card
    title="巴西葡萄牙语"
    href="/zh-cn/docs/locale/brazilian-portuguese"
    description="巴西葡萄牙语是一种罗曼语言，也是巴西的官方语言。"
  />
  <Card
    title="Chinese"
  ...
  <Card
    title="Indonesian"
    href="/zh-cn/docs/locale/indonesian"
    description="印度尼西亚语是世界上最大的群岛国家印度尼西亚的官方语言。"
  />
  <Card
    title="Japanese"
