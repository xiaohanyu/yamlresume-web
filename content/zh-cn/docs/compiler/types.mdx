...
| 属性        | 类型                                                                 | 必需 | 描述                            |
| ----------- | -------------------------------------------------------------------- | -------- | -------------------------------------- |
| `layouts[]` | [`DocxLayout`](#docxlayout) \| [`HtmlLayout`](#htmllayout) \| [`LatexLayout`](#latexlayout) \| [`MarkdownLayout`](#markdownlayout) | ⬜       | 多个输出布局配置。 |
...
| 属性       | 类型                        | 必需 | 描述                                                        |
| ---------- | --------------------------- | -------- | ------------------------------------------------------------------ |
| `aliases?` | `Record<SectionID, string>` | ⬜       | 用于分节名称的自定义别名，覆盖默认翻译。 |
...
| `lineSpacing?` | [`LineSpacing`](#linespacing)       | ⬜       | 文档的行间距。      |
...
| `showIcons?` | `boolean`                            | ⬜       | 是否显示链接和社交主页的图标。 |
| `showUrls?`  | `boolean`                            | ⬜       | 是否显示原始 URL 或将其隐藏在合理的文本后面。 |
...
| ------------- | ------------------------------------- | -------- | ----------------------------------------------------- |
| `engine`      | `'docx'`                              | ✅       | 生成简历的引擎。                    |
| `advanced?`   | [`DocxAdvanced`](#docxadvanced)       | ⬜       | 定义高级配置选项。               |
| `page?`       | [`DocxPage`](#docxpage)               | ⬜       | 定义文档演示的页面级设置。|
| `sections?`   | [`Sections`](#sections)               | ⬜       | 定义分节自定义设置。               |
| `template?`   | [`DocxTemplate`](#docxtemplate)       | ⬜       | 定义选定的模板。                        |
| `typography?` | [`DocxTypography`](#docxtypography)   | ⬜       | 定义文档格式的排版设置。  |
...
| ------------------ | ---------------------- | -------- | ------------------------------------ |
| `margins?`         | [`Margins`](#margins)  | ⬜       | 定义页边距设置。        |
| `paperSize?`       | [`DocxPaperSize`](#docxpapersize) | ⬜       | 定义纸张大小。              |
| `showPageNumbers?` | `boolean`              | ⬜       | 是否显示页码。     |
...
| 属性          | 类型                                | 必需 | 描述                      |
| ------------- | ----------------------------------- | -------- | -------------------------------- |
| `fontSize?`   | [`DocxFontSize`](#docxfontsize)     | ⬜       | 文档的基础字体大小。 |
| `fontFamily?` | `string`                            | ⬜       | 要使用的逗号分隔的字体家族列表。 |
| `lineSpacing?` | [`LineSpacing`](#linespacing)      | ⬜       | 文档的行间距。        |
...
这些语义值遵循 Tailwind CSS 的 leading 刻度：
