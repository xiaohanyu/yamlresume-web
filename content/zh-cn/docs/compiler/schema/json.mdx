...
[https://yamlresume.dev/schema.json](https://yamlresume.dev/schema.json)。但是，如果您想要一个精简版本用于您的 IDE/编辑器，您也可以使用我们 GitHub 仓库中的 canary 版本 [schema.json](https://github.com/yamlresume/yamlresume/blob/main/packages/core/src/schema/schema.json)。
