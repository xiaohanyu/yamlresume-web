...
| 属性        | 类型                                                                                         | 必需 | 验证规则            |
| ----------- | -------------------------------------------------------------------------------------------- | -------- | ------------------------------- |
| `layouts[]` | [`DocxLayoutSchema`](#docxlayoutschema) \| [`HtmlLayoutSchema`](#htmllayoutschema) \| [`LatexLayoutSchema`](#latexlayoutschema) \| [`MarkdownLayoutSchema`](#markdownlayoutschema) | ⬜       | 布局配置数组。 |
...
| `lineSpacing?` | [`LineSpacing`](#linespacing)      | ⬜       | 必须来自预定义的[行间距选项](#linespacing)   |
...
| 属性          | 类型                                                  | 必需 | 验证规则                                      |
| ------------- | ----------------------------------------------------- | -------- | --------------------------------------------------------- |
| `engine`      | `'docx'`                                              | ✅       | 必须是 "docx"                                        |
| `advanced?`   | [`DocxAdvancedSchema`](#docxadvancedschema)           | ⬜       | 参见[高级模式](#docxadvancedschema)            |
| `page?`       | [`DocxPageSchema`](#docxpageschema)                   | ⬜       | 参见[页面模式](#docxpageschema)                    |
| `sections?`   | [`SectionsSchema`](#sectionsschema)                   | ⬜       | 参见[分节模式](#sectionsschema)                |
| `template?`   | [`DocxTemplate`](#docxtemplate)                       | ⬜       | 必须来自预定义的[模板选项](#docxtemplate) |
| `typography?` | [`DocxTypographySchema`](#docxtypographyschema)       | ⬜       | 参见[排版模式](#docxtypographyschema)        |
...
| ------------------ | ---------------------- | -------- | ---------------------------------------------- |
| `margins?`         | [`MarginsSchema`](#marginsschema) | ⬜       | 参见[页边距模式](#marginsschema)           |
| `paperSize?`       | [`DocxPaperSize`](#docxpapersize) | ⬜       | 必须来自预定义的[纸张大小选项](#docxpapersize) |
| `showPageNumbers?` | `boolean`              | ⬜       | true/false                                     |
...
| 属性          | 类型                              | 必需 | 验证规则                                           |
| ------------- | --------------------------------- | -------- | ---------------------------------------------------------- |
| `fontSize?`   | [`DocxFontSize`](#docxfontsize)   | ⬜       | 必须来自预定义的[字体大小选项](#docxfontsize) |
| `fontFamily?` | `string`                          | ⬜       | 逗号分隔的字体家族列表。                   |
| `lineSpacing?`| [`LineSpacing`](#linespacing)     | ⬜       | 必须来自预定义的[行间距选项](#linespacing) |
...
- 必须是目标系统上可用的有效字体家族名称
- 示例：`Arial`、`Times New Roman`、`Calibri`
...
所有可能 DOCX 字体大小选项的联合类型。

**验证规则：**

- 必须是以下之一：`10pt`、`10.5pt`、`11pt`、`11.5pt`、`12pt`
- `10pt` 是默认字体大小

### DocxPaperSize

所有可能 DOCX 纸张大小选项的联合类型。
...
- 必须是以下之一：`calm`
- 另请参阅：[模板](/zh-cn/docs/layouts/docx/templates)
