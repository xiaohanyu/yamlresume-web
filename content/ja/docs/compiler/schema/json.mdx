...
[https://yamlresume.dev/schema.json](https://yamlresume.dev/schema.json)。ただし、IDE/エディター用の軽量版が必要な場合は、GitHub リポジトリの canary バージョン [schema.json](https://github.com/yamlresume/yamlresume/blob/main/packages/core/src/schema/schema.json) も使用できます。
...
- [v0.13.0](/schemas/v0.13.0/schema.json)
