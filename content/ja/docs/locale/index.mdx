...
<Cards>
  <Card
    title="ブラジルポルトガル語"
    href="/ja/docs/locale/brazilian-portuguese"
    description="ブラジルポルトガル語はロマンス言語であり、ブラジルの公用語です。"
  />
  <Card
    title="Chinese"
    href="/ja/docs/locale/chinese"
    description="簡体字中国語と繁体字中国語（香港と台湾）をサポートしています。"
  />
  <Card
    title="Dutch"
    href="/ja/docs/locale/dutch"
    description="オランダ語は、主にオランダとベルギーで話されている西ゲルマン語です。"
  />
  <Card
    title="English"
    href="/ja/docs/locale/english"
    description="新しい履歴書を作成する際、英語は YAMLResume のデフォルト言語です。"
  />
  <Card
    title="French"
    href="/ja/docs/locale/french"
    description="フランス語は世界中で話されるロマンス言語です。"
  />
  <Card
    title="German"
    href="/ja/docs/locale/german"
    description="ドイツ語は、主にドイツで話されている西ゲルマン語です。"
  />
  <Card
    title="Indonesian"
    href="/ja/docs/locale/indonesian"
    description="インドネシア語は、世界最大の島嶼国家であるインドネシアの公用語です。"
  />
  <Card
    title="Japanese"
    href="/ja/docs/locale/japanese"
    description="日本語は約1億2500万人に話されている東アジアの言語です。"
  />
  <Card
    title="Norwegian"
    href="/ja/docs/locale/norwegian"
    description="ノルウェー語は主にノルウェーで使用される北ゲルマン語です。"
  />
  <Card
    title="Spanish"
    href="/ja/docs/locale/spanish"
