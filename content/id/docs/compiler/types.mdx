...
| Kolom        | Tipe                                                                 | Wajib | Deskripsi                            |
| ----------- | -------------------------------------------------------------------- | -------- | -------------------------------------- |
| `layouts[]` | [`DocxLayout`](#docxlayout) \| [`HtmlLayout`](#htmllayout) \| [`LatexLayout`](#latexlayout) \| [`MarkdownLayout`](#markdownlayout) | ⬜       | Beberapa konfigurasi tata letak output. |
...
| `showIcons?` | `boolean`                            | ⬜       | Apakah menampilkan ikon untuk tautan dan profil.     |
| `showUrls?`  | `boolean`                            | ⬜       | Apakah menampilkan URL mentah atau menyembunyikannya di balik teks yang masuk akal. |
...
Konfigurasi tata letak DOCX.

| Kolom          | Tipe                                  | Wajib | Deskripsi                                           |
| ------------- | ------------------------------------- | -------- | ----------------------------------------------------- |
| `engine`      | `'docx'`                              | ✅       | Mesin untuk menghasilkan resume.                    |
| `advanced?`   | [`DocxAdvanced`](#docxadvanced)       | ⬜       | Mendefinisikan opsi konfigurasi lanjutan.               |
| `page?`       | [`DocxPage`](#docxpage)               | ⬜       | Mendefinisikan pengaturan tingkat halaman untuk presentasi dokumen.|
| `sections?`   | [`Sections`](#sections)               | ⬜       | Mendefinisikan pengaturan kustomisasi bagian.               |
| `template?`   | [`DocxTemplate`](#docxtemplate)       | ⬜       | Mendefinisikan template yang dipilih.                        |
| `typography?` | [`DocxTypography`](#docxtypography)   | ⬜       | Mendefinisikan pengaturan tipografi untuk pemformatan dokumen.  |

##### DocxAdvanced

Mendefinisikan opsi konfigurasi DOCX lanjutan.
...
Mendefinisikan pengaturan tingkat halaman DOCX untuk presentasi dokumen.

| Kolom               | Tipe                   | Wajib | Deskripsi                          |
| ------------------ | ---------------------- | -------- | ------------------------------------ |
| `margins?`         | [`Margins`](#margins)  | ⬜       | Mendefinisikan pengaturan margin halaman.        |
| `paperSize?`       | [`DocxPaperSize`](#docxpapersize) | ⬜       | Mendefinisikan ukuran kertas.              |
| `showPageNumbers?` | `boolean`              | ⬜       | Apakah menampilkan nomor halaman.     |

##### DocxTypography

Mendefinisikan pengaturan tipografi DOCX untuk pemformatan dokumen.

| Kolom          | Tipe                                | Wajib | Deskripsi                      |
| ------------- | ----------------------------------- | -------- | -------------------------------- |
| `fontSize?`   | [`DocxFontSize`](#docxfontsize)     | ⬜       | Ukuran font dasar untuk dokumen. |
| `fontFamily?` | `string`                            | ⬜       | Daftar keluarga font yang dipisahkan koma. |
| `lineSpacing?`| [`LineSpacing`](#linespacing)       | ⬜       | Spasi baris untuk dokumen.   |
...
- `10.5pt` - ukuran font 10.5pt
- `11pt` - ukuran font 11pt
- `11.5pt` - ukuran font 11.5pt
