...
| Kolom        | Tipe                                                                                         | Wajib | Aturan Validasi                |
| ----------- | -------------------------------------------------------------------------------------------- | -------- | ------------------------------- |
| `layouts[]` | [`DocxLayoutSchema`](#docxlayoutschema) \| [`HtmlLayoutSchema`](#htmllayoutschema) \| [`LatexLayoutSchema`](#latexlayoutschema) \| [`MarkdownLayoutSchema`](#markdownlayoutschema) | ⬜       | Beberapa konfigurasi tata letak output. |
...
Memvalidasi konfigurasi tata letak DOCX.

| Kolom          | Tipe                                                  | Wajib | Aturan Validasi                                      |
| ------------- | ----------------------------------------------------- | -------- | ----------------------------------------------------- |
| `engine`      | `'docx'`                                              | ✅       | Harus "docx"                                        |
| `advanced?`   | [`DocxAdvancedSchema`](#docxadvancedschema)           | ⬜       | Lihat [skema lanjutan](#docxadvancedschema)            |
| `page?`       | [`DocxPageSchema`](#docxpageschema)                   | ⬜       | Lihat [skema halaman](#docxpageschema)                    |
| `sections?`   | [`SectionsSchema`](#sectionsschema)                   | ⬜       | Lihat [skema bagian](#sectionsschema)                |
| `template?`   | [`DocxTemplate`](#docxtemplate)                       | ⬜       | Harus dari [opsi template](#docxtemplate) yang telah ditentukan |
| `typography?` | [`DocxTypographySchema`](#docxtypographyschema)       | ⬜       | Lihat [skema tipografi](#docxtypographyschema)        |

##### DocxAdvancedSchema

Memvalidasi opsi konfigurasi DOCX lanjutan.
...
| ------------------ | ---------------------- | -------- | ---------------------------------------------- |
| `margins?`         | [`MarginsSchema`](#marginsschema) | ⬜       | Lihat [skema margins](#marginsschema)           |
| `paperSize?`       | [`DocxPaperSize`](#docxpapersize) | ⬜       | Harus dari [opsi ukuran kertas](#docxpapersize) yang telah ditentukan |
| `showPageNumbers?` | `boolean`              | ⬜       | true/false                                     |
...
| Kolom          | Tipe                              | Wajib | Aturan Validasi                                           |
| ------------- | --------------------------------- | -------- | ---------------------------------------------------------- |
| `fontSize?`   | [`DocxFontSize`](#docxfontsize)   | ⬜       | Harus dari [opsi ukuran font](#docxfontsize) yang telah ditentukan |
| `fontFamily?` | `string`                          | ⬜       | Daftar keluarga font yang dipisahkan koma.                   |
| `lineSpacing?`| [`LineSpacing`](#linespacing)     | ⬜       | Harus dari [opsi spasi baris](#linespacing) yang telah ditentukan |
...
### DOCX Font Family Schema

Memvalidasi nama keluarga font untuk output DOCX.

**Aturan Validasi:**

- Harus nama keluarga font yang valid yang tersedia di sistem target
- Contoh: `Arial`, `Times New Roman`, `Calibri`
...
Union type untuk semua opsi ukuran font DOCX possible.

**Aturan Validasi:**

- Harus salah satu dari: `10pt`, `10.5pt`, `11pt`, `11.5pt`, `12pt`
- `10pt` adalah ukuran font default

### DocxPaperSize

Union type untuk semua opsi ukuran kertas DOCX possible.

**Aturan Validasi:**

- Harus salah satu dari: `a4`, `letter`
- `a4` adalah ukuran kertas default

### DocxTemplate

Union type untuk semua opsi template DOCX possible.

**Aturan Validasi:**

- Harus salah satu dari: `calm`
- Lihat juga: [templates](/id/docs/layouts/docx/templates)
