...
| Prop        | Tipo                                                                 | Obrigatório | Descrição                       |
| ----------- | -------------------------------------------------------------------- | ------------ | --------------------------------- |
| `layouts[]` | [`DocxLayout`](#docxlayout) \| [`HtmlLayout`](#htmllayout) \| [`LatexLayout`](#latexlayout) \| [`MarkdownLayout`](#markdownlayout) | ⬜️          | Configurações de layout.         |
...
| `showIcons?` | `boolean`                            | ⬜️          | Indica se devem ser mostrados ícones para hiperligações e perfis. |
| `showUrls?`  | `boolean`                            | ⬜️          | Indica se devem ser mostrados URLs em bruto ou ocultá-los atrás de um texto razoável. |
...
Configuração de layout DOCX.

| Prop          | Tipo                                  | Obrigatório | Descrição                                           |
| ------------- | ------------------------------------- | ------------ | ----------------------------------------------------- |
| `engine`      | `'docx'`                              | ✅           | Motor para gerar o currículo.                         |
| `advanced?`   | [`DocxAdvanced`](#docxadvanced)       | ⬜️          | Define opções de configuração avançada.               |
| `page?`       | [`DocxPage`](#docxpage)               | ⬜️          | Define opções ao nível de página para a apresentação do documento. |
| `sections?`   | [`Sections`](#sections)               | ⬜️          | Define a configuração de personalização de secções.   |
| `template?`   | [`DocxTemplate`](#docxtemplate)       | ⬜️          | Define o modelo selecionado.                          |
| `typography?` | [`DocxTypography`](#docxtypography)   | ⬜️          | Define opções tipográficas para o formato do documento. |

##### DocxAdvanced

Define opções de configuração avançada para DOCX.
...
Define opções ao nível de página para DOCX.

| Prop               | Tipo                   | Obrigatório | Descrição                |
| ------------------ | ---------------------- | ------------ | -------------------------- |
| `margins?`         | [`Margins`](#margins)  | ⬜️          | Define as margens de página. |
| `paperSize?`       | [`DocxPaperSize`](#docxpapersize) | ⬜️ | Define o tamanho de papel. |
| `showPageNumbers?` | `boolean`              | ⬜️          | Mostrar números de página. |

##### DocxTypography

Define opções tipográficas para DOCX.

| Prop          | Tipo                                | Obrigatório | Descrição                      |
| ------------- | ----------------------------------- | ------------ | ------------------------------ |
| `fontSize?`   | [`DocxFontSize`](#docxfontsize)     | ⬜️          | Tamanho base de fonte para o documento. |
| `fontFamily?` | `string`                            | ⬜️          | Uma lista de famílias de fontes separada por vírgulas. |
| `lineSpacing?`| [`LineSpacing`](#linespacing)       | ⬜️          | Espaçamento de linha para o documento. |
...
Tipo união que inclui todas as possíveis opções de tamanho de fonte DOCX.

- `10pt` - tamanho de fonte de 10pt (por defeito)
- `10.5pt` - tamanho de fonte de 10.5pt
- `11pt` - tamanho de fonte de 11pt
- `11.5pt` - tamanho de fonte de 11.5pt
- `12pt` - tamanho de fonte de 12pt

#### DocxPaperSize

Tipo união que inclui todas as possíveis opções de tamanho de papel DOCX.
...
Tipo união que inclui todas as possíveis opções de modelo DOCX.

Ver também: [templates](/pt/docs/layouts/docx/templates)
