...
| Prop        | Tipo                                                                                         | Obrigatório | Regras de validação            |
| ----------- | -------------------------------------------------------------------------------------------- | ------------ | ------------------------------- |
| `layouts[]` | [`DocxLayoutSchema`](#docxlayoutschema) \| [`HtmlLayoutSchema`](#htmllayoutschema) \| [`LatexLayoutSchema`](#latexlayoutschema) \| [`MarkdownLayoutSchema`](#markdownlayoutschema) | ⬜️          | Array de configurações layout |
...
Valida a configuração do layout DOCX.

| Prop          | Tipo                                                  | Obrigatório | Regras de validação                                      |
| ------------- | ----------------------------------------------------- | ------------ | ----------------------------------------------------- |
| `engine`      | `'docx'`                                              | ✅           | Deve ser "docx"                                        |
| `advanced?`   | [`DocxAdvancedSchema`](#docxadvancedschema)           | ⬜️          | Ver [esquema avançado](#docxadvancedschema)            |
| `page?`       | [`DocxPageSchema`](#docxpageschema)                   | ⬜️          | Ver [esquema de página](#docxpageschema)               |
| `sections?`   | [`SectionsSchema`](#sectionsschema)                   | ⬜️          | Ver [esquema de secções](#sectionsschema)              |
| `template?`   | [`DocxTemplate`](#docxtemplate)                       | ⬜️          | Deve estar em [opções de modelo](#docxtemplate)        |
| `typography?` | [`DocxTypographySchema`](#docxtypographyschema)       | ⬜️          | Ver [esquema de tipografia](#docxtypographyschema)     |

##### DocxAdvancedSchema

Valida opções de configuração avançada de DOCX.
...
| ------------------ | ---------------------- | ------------ | -------------------------------------------------- |
| `margins?`         | [`MarginsSchema`](#marginsschema) | ⬜️ | Ver [esquema de margens](#marginsschema)           |
| `paperSize?`       | [`DocxPaperSize`](#docxpapersize) | ⬜️ | Deve estar em [opções de tamanho de papel](#docxpapersize) |
| `showPageNumbers?` | `boolean`              | ⬜️          | true/false                                         |
...
| Prop          | Tipo                              | Obrigatório | Regras de validação                                           |
| ------------- | --------------------------------- | ------------ | ---------------------------------------------------------- |
| `fontSize?`   | [`DocxFontSize`](#docxfontsize)   | ⬜️          | Deve estar em [opções de tamanho de fonte](#docxfontsize)   |
| `fontFamily?` | `string`                          | ⬜️          | Uma lista de famílias de fontes separada por vírgulas.      |
| `lineSpacing?`| [`LineSpacing`](#linespacing)     | ⬜️          | Deve ser uma das [opções de espaçamento de linha](#linespacing) |
...
- Deve ser um de: `10pt`, `10.5pt`, `11pt`, `11.5pt`, `12pt`
...
- `a4` é o tamanho de papel por defeito
